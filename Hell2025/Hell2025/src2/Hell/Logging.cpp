...
namespace Logging {
    ...
    const char* orange = "\x1b[38;5;208m";        // standard orange
    const char* orange_bright = "\x1b[38;5;214m"; // bright orange
    const char* orange_red    = "\x1b[38;5;202m"; // deep orange/red-orange
