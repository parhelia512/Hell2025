...
namespace File {
    ...
    HeightMapData LoadHeightMap(const std::string filename) {
        ...
        // heightmapData.textureWidth = header.width;
        // heightmapData.textureHeight = header.height;
        // 
        // // Read the pixel data
    ...
    void SaveHeightMap(const HeightMapData& heightmapData) {
        ...
        //
        //// Error check
        //size_t floatCount = heightmapData.textureWidth * heightmapData.textureHeight;
        //if (heightmapData.data.size() != floatCount) {
        //    std::cout << "File::SaveHeightMap() failed because data.size() was " << heightmapData.data.size() << " but width(" << heightmapData.textureWidth << ") * height(" << heightmapData.textureHeight << ") equals " << floatCount << "\n";
        //    return;
        //}
        //
        ...
        //header.width = heightmapData.textureWidth;
        //header.height = heightmapData.textureHeight;
        //
        //// Write the header
